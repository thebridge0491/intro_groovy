(ns leiningen.new.org.sandbox.groovymixed
  (:require
...
(defn org.sandbox.groovymixed
  "A Leiningen template for mixed Groovy project (choices skeleton: skeleton_groovy).
  
usage: [LEIN_JVM_OPTS='-Dskeleton=skeleton_groovy'] lein new org.sandbox.groovymixed [groupId/]artifactId
LEIN_JVM_OPTS='-DdataFile=data.yaml -DdataFmt=yaml -DffiLib=jna' lein new org.sandbox.groovymixed org.sandbox/intro_jvm.util"
  [raw-name]
  (let [skel-dir (format "org/sandbox/groovymixed/%s" (System/getProperty "skeleton" "skeleton_groovy"))
    ...
    (main/info "Generating fresh 'lein new' org.sandbox.groovymixed project.")
