...
// swig -java -v -package ${package} -I${symbol_dollar}(PREFIX)/include -outdir src/main/java/${packageInPathFormat}/ -o build/classic_c_wrap.c src/main/groovy/${packageInPathFormat}/Classic_c.i
