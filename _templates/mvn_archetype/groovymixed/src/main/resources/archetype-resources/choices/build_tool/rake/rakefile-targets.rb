...
${symbol_pound}SCALADOC_OPTS = "${symbol_pound}{ENV['SCALADOC_OPTS']} -author "
GROOVYDOC_OPTS = "${symbol_pound}{ENV['GROOVYDOC_OPTS']} -author -private "
...
${symbol_pound}desc 'Generate documentation (scaladoc)'
${symbol_pound}task :scaladoc do
${symbol_pound}  rm_rf("target/docs/scaladoc")
${symbol_pound}  mkdir_p("target/docs/scaladoc")
${symbol_pound}  sh "scaladoc ${symbol_pound}{SCALADOC_OPTS} -classpath ${symbol_pound}{VARS.classpath_test}:${symbol_pound}{CLASSES_DIR}:${symbol_pound}{CLASSES_TEST_DIR} -d target/docs/scaladoc ${symbol_pound}{FileList['src/main/scala/**/*.scala']}" if 0 != FileList['src/main/scala/**/*.scala'].size
${symbol_pound}end
...
task :groovydoc do
  ...
  sh "groovydoc ${symbol_pound}{GROOVYDOC_OPTS} -classpath ${symbol_pound}{VARS.classpath_test}:${symbol_pound}{CLASSES_DIR}:${symbol_pound}{CLASSES_TEST_DIR} -d target/docs/groovydoc ${symbol_pound}{FileList['src/main/groovy/**/*.groovy']}" if 0 != FileList['src/main/groovy/**/*.groovy'].size
end
...
${symbol_pound}desc 'Lint check (scalastyle)'
${symbol_pound}task :scalastyle do
${symbol_pound}  ${symbol_pound}sh "scalastyle -c config/scalastyle_config.xml src/main/scala || true"
${symbol_pound}  sh "java -jar ${symbol_pound}{ENV['HOME']}/.ant/lib/ivy.jar -mode dynamic -types jar \
${symbol_pound}		-confs default -dependency org.scalastyle scalastyle_${symbol_pound}{SCALA_COMPAT} \
${symbol_pound}		'[0.1.0,)' -main org.scalastyle.Main -- \
${symbol_pound}		-c config/scalastyle_config.xml src/main/scala || true"
${symbol_pound}end

desc 'Lint check (codenarc)'
task :codenarc do
  sh "java -jar ${symbol_pound}{ENV['HOME']}/.ant/lib/ivy.jar -mode dynamic -types jar \
		-confs default -dependency org.codenarc CodeNarc '[0.18-1,)' \
