Intro_groovy-Scriptexplore
===========================================
.. .rst to .html: rst2html5 foo.rst > foo.html
..                pandoc -s -f rst -t html5 -o foo.html foo.rst

Script explore sub-package for Groovy Intro examples project.
...
Usage
-----
        [env RSRC_PATH=<path>/resources] java -jar intro_groovy-scriptexplore-<version>.jar [-h]
